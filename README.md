...
- **Branch F** (broadcast / ignition): benchmark scaffold complete; no model evidence yet. The 4,095-case audit contains 819 complete cue-strength sweeps and 819 held-out content/strength conjunctions across action, report, uncertainty, reallocation, memory, and language-shaped consumers. Local action remains available below threshold; the other five consumers become available in one perfectly aligned ignition window. See `audits/branch_f_broadcast_dataset.json`.
